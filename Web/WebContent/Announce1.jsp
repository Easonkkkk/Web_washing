...
<nav class=" navbar-fixed-top navbar navbar-inverse ">
		<div class="container">
		    <p class="navbar-text" onclick="window.location.href='JDisplaying.jsp'">首页</p>
...
<br>
			...
			<div  style="font-size:10px;">
				<h1  style="text-align:center;">关于洗衣房部分洗衣机故障的通知</h1>
	<br>
		<div style="text-align: center;">
			...
			<div class="sp-content">
				...
				<p style="white-space: normal;">
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span
						style="font-size: 19px; font-family: 宋体">由于最近各寝室楼洗衣房洗衣机部分设备的频繁发生，我们已对故障的洗衣机进行屏蔽处理，同学们无需担心自己所挑选的洗衣机为已故障机器。</span>
				</p>
				<p style="text-align: left; text-indent: 37px; text-autospace: none">
					<span style="font-size: 19px; font-family: 宋体">通知如下，望请同学们查收并且互相传达。</span>
				</p>
				<p style="text-align: left; text-indent: 37px; text-autospace: none">
					...
					<br>
					<span style="font-family: 宋体; font-size: 19px;">2020年12月18日</span>
                   ...
                   <a   
						...
						href="Announce2.jsp"
						title="公告2:关于学生个人财产管理的通知" 
						target="_blank" class="z-attachment xlsx">公告2:关于学生个人财产管理的通知</a>

                   <br>
                   <br>
                   <a   style="font-size:15px;"
						href="Announce3.jsp"
						title="公告3:关于洗衣房新定规则的通知" 
						target="_blank" class="z-attachment xlsx">公告3:关于洗衣房新定规则的通知</a>

                   <br>
                   <br>
                    <a  style="font-size:15px;"
						href="Announce4.jsp"
						title="公告4:关于遗失物品拾取的通知" 
						target="_blank" class="z-attachment xlsx">公告4:关于遗失物品拾取的通知</a>
